...
public class VerticalPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener{
    ...
    private VerticalInfiniteCycleViewPager mViewPager; // viewPager对象
    ...
    public VerticalPagerAdapter(FragmentManager fragmentManager, VerticalInfiniteCycleViewPager viewPager ,List<Fragment> fragmentList) {
